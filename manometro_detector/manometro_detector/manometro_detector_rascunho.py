...
MAX_POINTER_PIXELS = 2500    # Limite máximo de pixels brancos (ruído). Se for maior que isso, é considerado Miss Detection!
        ...
        if corners is not None:
            ...
            if best_mask is not None:
                ...
                if white_pixels > MAX_POINTER_PIXELS:
                    print(f"[-] MISS DETECTION REJEITADA! Excesso de ruído: {white_pixels} px (Max: {MAX_POINTER_PIXELS})")
                else:
